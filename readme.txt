...
* **Changed:** Bump WordPress version "tested up to" 6.2 (props [@Sidsector9](https://github.com/Sidsector9), [@jeffpaul](https://github.com/jeffpaul) via [#172](https://github.com/10up/windows-azure-storage/issues/172)).
