...
(function ($, window, undefined) {
	...
	$document.on('click', '.windows-azure-storage-media-button', function(event) {
	...
	$document.on('change', '.azure-container-selector', function(event) {
		event.preventDefault();

		var htmlForm = document.getElementById('azure-settings-form'),
			divCreateContainer = document.getElementById('div-create-container');
	...
	$document.on('click', '.azure-create-container-button', function(event) {
		event.preventDefault();
